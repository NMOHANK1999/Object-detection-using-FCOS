...
class VOCDataset(Dataset):
    ...
    def preload_anno(self):
        ...
        for index in self.index_list:
            ...
            for obj in root.findall("object"):
              ...
              #if class_name in VOCDataset.INV_CLASS:
    ...
    def get_random_augmentations(self):
        ...
        #     v2.RandomResizedCrop(size=(self.size, self.size), antialias=True),
        ...
        train_transform = [
            ...
            transforms.RandomResizedCrop(size=(self.size, self.size), scale=(0.08, 1.0), ratio=(0.75, 1.3333)),
